...
Hi! My name is **Brian Huang**, and I’m a first-year **EECS Ph.D. student** at UC Irvine advised by [**Prof. Athina Markopoulou**](https://athinagroup.eng.uci.edu/athina/). I am a part of [**AthinaGroup**](https://athinagroup.eng.uci.edu/athina/), [**ProperData**](https://properdata.eng.uci.edu/), and [**ProperAI**](https://properai.eng.uci.edu/). I graduated with a B.S. and honors from UC Santa Cruz where I was super fortunate to have been able to work with [**Prof. Ram Sundara Raman**](https://ramakrishnansr.com/).

# Research Interests

My current research lies broadly in the intersections of the areas of **satellite networks, network security, internet measurement, internet censorship, privacy/policy, and AI Finance**.
